...
@section('content')
    ...
    <section class="content">
        <form action="{{route('adminUpdateEditSibling',  ['id' => $sibling->user_id, 'siblingId' => $sibling->id])}}" method="POST">
            {{ csrf_field() }}
            {{method_field('PUT')}}
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('siblingName') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="siblingName" id="siblingName"  value="{{$sibling->name}}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('siblingAge') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" class="form-control" name="siblingAge" id="siblingAge"  value="{{$sibling->age}}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('siblingEducationalLevel') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="siblingEducationalLevel" id="siblingEducationalLevel"  value="{{$sibling->educationalLevel}}">
